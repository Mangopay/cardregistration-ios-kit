...
We recommend migrating to our new [Vault SDK for iOS](https://github.com/Mangopay/mangopay-ios-vault-sdk) instead. The new SDK provides the same functionality of [card registration flow](https://mangopay.com/docs/endpoints/direct-card-payins#card-registration-object), with Swift language support., better performance, and continued support.

For details on migrating from this SDK to the new Swift SDK, see our [migration guide](https://mangopay.com/docs/sdk/vault-ios). 
